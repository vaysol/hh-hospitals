<div class="container row">
    <div>
        <?php if ($blogs){foreach($blogs as $data){} ?>
        <h2>Edit Blog</h2>
        <?php }else{ ?>
        <h2>Add Blog</h2>
        <?php } ?>
    ...
    <div class="col-md-8">
        <form action="<?= base_url()?>/admin/blogs/save/" class="was-validated1 row" method="POST"
            enctype="multipart/form-data">
            <div class="mb-3 col-md-6" hidden>
                <label for="id" class="form-label">Blog Id</label>
                <input value="<?php if (!empty($data['id'])){ echo $data['id']; } ?>" type="text" class="form-control"
                    id="id" placeholder="Blog Id" name="id">
            </div>
            ...
            <div class="mb-3 col-md-6">
                ...
                <input value="<?php echo $data['author']; ?>" type="text" class="form-control" id="author"
