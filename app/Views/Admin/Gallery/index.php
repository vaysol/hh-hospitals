<div class="mb-3 row">
    ...
    <div class="col-md-4">
        <a href="<?php echo base_url(); ?>/admin/gallery/add" class="btn btn-dark float-end"><i
...
<table id="example" class="table bg-light bg-gradient table-bordered bg-opacity-25 rounded-3" style="width:100%;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><img class="list_image" src="<?= base_url()?>/assets/images/gallery/desktop/<?php echo $gallery['desktop_image']; ?>"></td>
            <td><img class="list_image" src="<?= base_url()?>/assets/images/gallery/mobile/<?php echo $gallery['mobile_image']; ?>"></td>
            ...
            <td>
                <a class="text-decoration-none" href="<?php echo base_url().'/admin/gallery/edit/'.$gallery['id']; ?>">
                    <i class="fa fa-pencil fa-lg mx-3" aria-hidden="true" style="color:#3a9124;"></i>
                </a>
                <a class="text-decoration-none" href="<?php echo base_url().'/admin/gallery/delete/'.$gallery['id']; ?>">
