<div class="container row">
    ...
    <div class="col-md-8">
        <form action="<?= base_url()?>/admin/news/save/" class="was-validated1 row" method="POST"
            ...
            <div class="mb-3 col-md-6" hidden>
                ...
                <input value="<?php if (!empty($data['id'])){ echo $data['id']; } ?>" type="text" class="form-control"
                    id="id" placeholder="News Id" name="id">
            </div>
            ...
            <div class="mb-3 col-md-6">
                ...
                <?php if (empty($data['id'])){ ?>
                <input value="<?php echo $data['place']; ?>" type="text" class="form-control" id="place" placeholder="Place" name="place"  required>
                <?php }else{ ?>
                <input value="<?php echo $data['place']; ?>" type="text" class="form-control" id="place" placeholder="Place" name="place" required>
                <?php } ?>
                <div class="invalid-feedback">Please fill out this field.</div>
