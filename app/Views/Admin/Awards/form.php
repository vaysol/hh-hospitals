<div class="container row">
    <div>
        <?php if ($awards){foreach($awards as $data){} ?>
            <h2>Edit Award</h2>
            <?php }else{ ?>
            <h2>Add Award</h2>
        <?php } ?>
    ...
    <div class="col-md-8">
        <form action="<?= base_url()?>/admin/awards/save/" class="was-validated1 row" method="POST"
            enctype="multipart/form-data">
            <div class="mb-3 col-md-6" hidden>
                <label for="id" class="form-label">Award Id</label>
                <input value="<?php if (!empty($data['id'])){ echo $data['id']; } ?>" type="text" class="form-control"
                    id="id" placeholder="Award Id" name="id">
            </div>
            ...
            <div class="mb-3 col-md-6">
                ...
                <input value="<?php echo $data['presenter']; ?>" type="text" class="form-control" id="presenter"
                    placeholder="Presenter" name="presenter" required>
                <div class="invalid-feedback">Please fill out this field.</div>
            </div>
            ...
            <div class="mb-3 col-md-6">
                ...
                <input value="<?php echo $data['year']; ?>" type="number" class="form-control" id="year" min='1900' max='<?= date('Y'); ?>'
    ...
    <div class="col-md-4">
        ...
        <img id="image_preview"
            src="<?= base_url()?>/assets/images/award/<?php echo $data['image']; ?>"
