<div class="container row">
    ...
    <div class="col-md-8">
        <form action="<?= base_url()?>/admin/banners/save/" class="was-validated1 row" method="POST"
            enctype="multipart/form-data">
            <div class="mb-3 col-md-6" hidden>
                <label for="id" class="form-label">Banner Id</label>
                <input value="<?php if (!empty($data['id'])){ echo $data['id']; } ?>" type="text" class="form-control"
                    id="id" placeholder="Banner Id" name="id">
            </div>
            ...
            <div class="mb-3 col-md-6">
                ...
                <input value="<?php echo $data['priority']; ?>" type="number" class="form-control" id="priority"
                    placeholder="Enter username" name="priority" >
                <div class="invalid-feedback">Please fill out this field.</div>
            </div>
            ...
            <div class="mb-3 col-md-6">
                ...
                <input value="<?php if (!empty($data['desktop_image'])){echo $data['desktop_image'];} ?>" type="file"
                    ...
                    <?php if (empty($data['desktop_image'])){ echo ""; } ?>>
                <div class="invalid-feedback">Please fill out this field.</div>
            </div>
            ...
            <div class="mb-3 col-md-6">
                ...
                <input value="<?php if (!empty($data['mobile_image'])){ echo $data['mobile_image']; }?>" type="file"
                    ...
                    <?php if (empty($data['mobile_image'])){ echo ""; } ?>>
                <div class="invalid-feedback">Please fill out this field.</div>
            </div>
    ...
    <div class="col-md-4">
        ...
        <img id="desktop_image_preview"
            src="<?= base_url()?>/<?php echo $data['desktop_image']; ?>.webp"
            style="width: 100%;height: auto;object-fit: cover;">
        <p></p>
        <p>Mobile Image :</p>
        <img id="mobile_image_preview"
            src="<?= base_url()?>/<?php echo $data['mobile_image']; ?>.webp"
            style="width: 100%;height: auto;object-fit: cover;">
    </div>
    <?php }else{ ?>
    <div class="col-md-4">
